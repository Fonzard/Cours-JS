...
let bookData = [
  ...
  },
  {
    ...
    "image":"https://res04.sites.3wa.io/yepages-api/images/pars-vite.jpg"
  },
  {
    ...
    "image":"https://res04.sites.3wa.io/yepages-api/images/hunger-games.jpg"
  },
  {
    "title":"Da Vinci Code",
    "category":"Polar Adulte",
    "author":"Dan Brown",
    "resume":"Robert Langdon, un éminent spécialiste de symbologie de Harvard, est convoqué au Louvre pour examiner une série de pictogrammes en rapport avec l'œuvre de Léonard de Vinci. En déchiffrant le code, il met à jour l'un des plus grands mystères de notre temps... et devient un homme traqué.",
    "image":"https://res04.sites.3wa.io/yepages-api/images/da-vinci-code.jpg"
  },
  {
    "title":"La huitième couleur",
    "category":"Fantasy Adulte",
    "author":"Terry Pratchett",
    "resume":"Dans une dimension lointaine et passablement farfelue, un monde en forme de disque est juché sur le dos de quatre éléphants, eux-mêmes posés sur une tortue.  À Ankh-Morpork, l'une des villes du Disque-Monde, les habitants croyaient avoir tout vu. Et Deuxfleurs avait l'air tellement inoffensif, avec son Bagage de bois magique circulant sur une myriade de petites jambes... Tellement inoffensif que le Praticien a chargé le calamiteux sorcier Rincevent de sa sécurité dans la cité quadrillée par la guilde des voleurs et celle des assassins. Car Deuxfleurs appartient à l'espèce la plus redoutable qui soit : c'est un touriste...",
    "image":"https://res04.sites.3wa.io/yepages-api/images/8-couleur.jpeg"
  },
  {
    "title":"La horde du Contrevent",
    "category":"Science-Fiction Adulte",
    "author":"Alain Damasio",
    "resume":"Ils sont vingt-trois, forment la trente-quatrième Horde du Contrevent et ont entre vingt-sept et quarante-trois ans. Dans un monde balayé par les vents, ils ont été formés depuis l'enfance dans un seul but : parcourir le monde, d'ouest en est, de l'Aval vers l'Amont, à contre-courant face au vent, à travers la plaine, l'eau et les pics glacés,  pour atteindre le mythique Extrême-Amont, la source de tous les vents.",
    "image":"https://res04.sites.3wa.io/yepages-api/images/horde_hd.jpg"
  },
  {
    "title":"Les chroniques martiennes",
    "category":"Science-Fiction Adulte",
    "author":"Ray Bradbury",
    "resume":"2030 Les Terriens arrivent enfin sur Mars. Ils découvrent une bien curieuse planète dont les habitants ont des yeux d'or, lisent dans les pensées et ont peut-être atteint la suprême sagesse... Le rêve martien vient relayer le rêve américain. Jusqu'au jour où il tourne au cauchemar...",
    "image":"https://res04.sites.3wa.io/yepages-api/images/chroniques-martiennes.jpeg"
  },
  {
    "title":"Le maitre du Haut-Chateau",
    "category":"Science-Fiction Adulte",
    "author":"Philippe K. Dick",
    "resume":"En 1947 avait lieu la capitulation des Alliés devant les forces de l'Axe. Cependant que Hitler avait imposé la tyrannie nazie à l'Est des Etats Unis, l'Ouest avait été attribué aux Japonais. Quelques années plus tard, la vie avait repris son cours normal dans la zone occupée par les Nippons. Ils avaient apporté avec eux l'usage du Yi-king, le livre des transformations, le célèbre oracle chinois dont l'origine se perd dans la nuit des temps. Pourtant dans cette nouvelle civilisation, une rumeur étrange circulait. Un homme vivant dans un Haut Château, un écrivain de science-fiction, avait écrit un ouvrage qui racontait la victoire des Alliés en 1945.",
    "image":"https://res04.sites.3wa.io/yepages-api/images/Le-Maitre-du-Haut-Chateau.jpg"
  }
]
